...
public enum MarkupParseError {
  ...
  MULTIPLE_ATTRIBUTE_BIND_BY_NAME_OPERATORS(args -> "The bind-by-name operator & may only be used once!"),
  COMBINED_ATTRIBUTE_BIND_BY_NAME_OPERATOR(args -> "The bind-by-name operator & cannot be combined with any other attribute-operators!"),
  UNSUPPORTED_BIND_BY_NAME_EXPRESSION(args -> "The bind-by-name operator & only supports either identifiers, or member-access-chains of identifiers"),
