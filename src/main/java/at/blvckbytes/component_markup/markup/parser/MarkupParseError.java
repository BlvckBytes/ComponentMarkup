...
public enum MarkupParseError implements ErrorMessage {
  ...
  VALUELESS_BINDING("Let-bindings always require a value to be bound"),
  ...
  EMPTY_ATTRIBUTE_NAME("This attribute-name is empty"),
  EMPTY_BINDING_NAME("This binding-name is empty"),
