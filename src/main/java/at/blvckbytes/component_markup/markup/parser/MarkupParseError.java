...
public enum MarkupParseError {
  ...
  LITERAL_INTRINSIC_MARKUP_ATTRIBUTE(args -> "Intrinsic attribute with markup-values { ... } always use the * prefix"),
  ...
  EXPECTED_EXPRESSION_ATTRIBUTE_VALUE(args -> "The attribute " + args[0] + " of tag " + args[1] + " expected a literal (string, boolean or number) or a bound expression"),
  ...
  SPREAD_DISALLOWED_ON_NON_EXPRESSION(args -> "The spread-operator ... is only allowed on expression-attributes: [" + args[0] + "]=\"<expression>\""),
