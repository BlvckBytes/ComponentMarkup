...
import at.blvckbytes.component_markup.markup.ast.node.control.ContentNode;
...
public class ContentTag extends TagDefinition {
  ...
  public boolean matchName(InputView tagName) {
    return tagName.contentEquals("content", true);
  }
  ...
  public @NotNull MarkupNode createNode(
    ...
    return new ContentNode(tagName);
  }
}
